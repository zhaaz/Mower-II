# Transformation/trafo_gui_test_app.py
...
class TrafoGuiTestApp(ctk.CTk):
    def __init__(self):
        super().__init__()

        self.title("Mower II - Trafo Testprogramm")
    ...
    def _build_ui(self):
        ...
        title = ctk.CTkLabel(
            self,
            text="Mower II - Trafo Testprogramm",
        ...
        self.lbl_xyz_status.grid(row=0, column=0, padx=10, pady=8, sticky="w")

        self.lbl_tracker_status = ctk.CTkLabel(status_frame, text="Tracker: -")
        self.lbl_tracker_status.grid(row=1, column=0, padx=10, pady=8, sticky="w")

        self.lbl_trafo_status = ctk.CTkLabel(status_frame, text="Trafo gültig: Nein")
        self.lbl_trafo_status.grid(row=2, column=0, padx=10, pady=8, sticky="w")

        log_frame = ctk.CTkFrame(self)
        log_frame.grid(row=3, column=0, padx=20, pady=10, sticky="nsew")

        self.logbox = ctk.CTkTextbox(log_frame, height=160)
